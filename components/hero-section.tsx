...
import { Logo } from "@/components/logo"; // Assuming this is defined elsewhere
import { ArrowRight, Menu, Rocket, X, Star } from "lucide-react";
import { Button } from "@/components/ui/button"; // Assuming this is defined elsewhere
...
export default function HeroSection() {
  ...
  return (
    <>
                    ...
                    >
                      ...
                      >
                        <DropdownMenuTrigger asChild>
                          <button className="text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white duration-150">
                            Pages
                          </button>
                        </DropdownMenuTrigger>
      ...
      <div className="relative flex h-[50rem] w-full items-center justify-center bg-transparent">
            ...
            <div className="relative py-24 lg:py-28">
              <div className="mx-auto max-w-7xl px-6 md:px-12">
                <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                  {/* Professional Yellow Pill-Shaped Announcement Link */}
                  <Link
                    href="/"
                    className={cn(
                      "rounded-full mx-auto flex w-fit items-center gap-2 border border-[#FFD700]/40 bg-[#FFD700]/10 p-1 pr-3 transition-colors hover:border-[#FFD700] ",
                      YELLOW_TEXT // Text is yellow for contrast
                    )}
                  >
                    <span
                      className={cn(
                        YELLOW_BG,
                        "rounded-full px-2 py-1 text-xs font-medium text-black"
                      )}
                    >
                      NEW
                    </span>
                    <span className="text-sm">Introducing WeBroPk Agency</span>

                    <span className="block h-4 w-px bg-zinc-400 dark:bg-zinc-600"></span>

                    <ArrowRight className="size-4" />
                  </Link>

                  {/* Impactful Headline Typography - Black/White */}
                  <h1 className="mt-8 text-4xl font-extrabold tracking-tight md:text-6xl xl:text-7xl xl:leading-[1.1] text-black dark:text-white">
                    Boost Your Digital Growth
                    <br />
                    with <span className={YELLOW_TEXT}>WeBroPk</span>
                  </h1>

                  {/* Enhanced Body Copy - Gray for subtlety */}
                  <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block text-zinc-600 dark:text-zinc-400">
                    WeBroPk delivers high-quality Web Development, SEO, Digital
                    Marketing, and Branding solutions to help your business grow
                    and scale fast.
                  </p>

                  <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden text-zinc-600 dark:text-zinc-400">
                    Professional Web Dev, SEO, and Marketing services designed
                    to grow your brand online.
                  </p>

                  {/* Call To Action - Solid Yellow */}
                  <div className="mt-8">
                    <Button
                      size="lg"
                      asChild
                      className={cn(
                        YELLOW_BG,
                        YELLOW_HOVER_BG,
                        "group relative overflow-hidden transition-all duration-300 ease-out hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-yellow-500/30 dark:shadow-yellow-500/20 text-black", // Text is black on yellow
                        YELLOW_RING
                      )}
                    >
                      <Link href="#">
                        {/* Rocket icon - Black on Yellow */}
                        <Rocket className="relative size-5 mr-2 transition-transform group-hover:-translate-y-[1px] fill-black" />
                ...
                <div className="x-auto relative mx-auto mt-8 max-w-lg sm:mt-12">
                  {/* Subtle Grid Pattern Behind Carousel (Kept for texture) */}
                  <div className="absolute inset-0 -top-8 left-1/2 -z-20 h-56 w-full -translate-x-1/2 [background-image:linear-gradient(to_bottom,transparent_98%,theme(colors.gray.200/75%)_98%),linear-gradient(to_right,transparent_94%,_theme(colors.gray.200/75%)_94%)] [background-size:16px_35px] [mask:radial-gradient(black,transparent_95%)] dark:opacity-10 dark:[background-image:linear-gradient(to_bottom,transparent_98%,theme(colors.zinc.800/75%)_98%),linear-gradient(to_right,transparent_94%,_theme(colors.zinc.800/75%)_94%)]"></div>
                  ...
                  >
                    {/* Slide 1: RAR Group (Star Client) */}
                    <SwiperSlide className="px-2">
                      <div className="bg-white/70 backdrop-blur-md dark:bg-zinc-900/70 rounded-2xl h-44 max-w-lg border border-zinc-200/50 dark:border-zinc-800/50 p-6 flex flex-col items-center justify-center shadow-xl transition-all duration-300 hover:shadow-yellow-500/30 dark:hover:shadow-yellow-500/10 group cursor-pointer">
                        <div className="flex items-center gap-2 mb-2">
                          <Star className="w-8 h-8 text-yellow-500 fill-yellow-500 group-hover:scale-110 transition-transform" />
                          <h3 className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-600 to-amber-600 dark:from-yellow-400 dark:to-amber-500">
                            RAR Group
                          </h3>
                        </div>
                        <Badge
                          variant="secondary"
                          className="bg-yellow-100 text-yellow-800 hover:bg-yellow-200 border-yellow-200 mb-2"
                        >
                          Star Client
                        </Badge>
                    ...
                    <SwiperSlide className="px-2">
                      <div className="bg-white/70 backdrop-blur-md dark:bg-zinc-900/70 rounded-2xl h-44 max-w-lg border border-zinc-200/50 dark:border-zinc-800/50 p-6 flex flex-col items-center justify-center shadow-xl transition-all duration-300 hover:shadow-yellow-500/30 dark:hover:shadow-yellow-500/10 group cursor-pointer">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <h3 className="text-2xl md:text-3xl font-bold text-zinc-800 dark:text-zinc-100 group-hover:text-pink-500 transition-colors">
                            Glowora
                          </h3>
                        </div>
                        <Badge
                          variant="outline"
                          className="text-zinc-500 border-zinc-200 mb-2"
                        >
                          Cosmetics Client
                        </Badge>
                        <p className="text-center text-sm font-medium text-muted-foreground">
                          Beauty Brand & Ecommerce
                        </p>
                      </div>
                    </SwiperSlide>

                    {/* Slide 3: Call to Action (Placeholder to loop nicely) */}
                    <SwiperSlide className="px-2">
                      <div className="bg-white/70 backdrop-blur-md dark:bg-zinc-900/70 rounded-2xl h-44 max-w-lg border border-zinc-200/50 dark:border-zinc-800/50 p-6 flex flex-col items-center justify-center shadow-xl transition-all duration-300 hover:shadow-yellow-500/30 dark:hover:shadow-yellow-500/10">
                        <h3 className="text-xl font-bold text-zinc-800 dark:text-zinc-100 mb-2">
                          Your Brand Here?
                        </h3>
                        <p className="text-center text-sm text-muted-foreground mb-4">
                          Join our list of successful partners.
                        </p>
                        <Button
                          size="sm"
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0 z-0 overflow-visible">
        {/* Soft radial grid vignette (Black/White theme) */}
        <div
          className={cn(
            "absolute inset-[-1px] opacity-[0.24]",
            "[background-size:40px_40px]",
            "[background-image:linear-gradient(to_right,#e4e4e7_1px,transparent_1px),linear-gradient(to_bottom,#e4e4e7_1px,transparent_1px)]",
            "dark:[background-image:linear-gradient(to_right,#262626_1px,transparent_1px),linear-gradient(to_bottom,#262626_1px,transparent_1px)]",
            "[mask-image:radial-gradient(circle_at_center,black_25%,transparent_90%)]",
            "dark:[mask-image:radial-gradient(circle_at_center,white_25%,transparent_90%)]"
          )}
        />

        {/* Large ambient glow behind hero content (Yellow/Amber theme) */}
        {/* Using a subtle yellow/amber glow for theme compliance */}
        <div className="absolute inset-x-0 top-1/2 mx-auto h-[55%] w-full max-w-5xl -translate-y-1/3 rounded-[999px] bg-yellow-500/25 opacity-70 blur-[160px] dark:bg-amber-900/50" />

        {/* Animated blurred gradient orbs (Replaced with Amber/Yellow) */}
        <div
          className="absolute -left-40 -top-32 h-80 w-80 rounded-full bg-gradient-to-tr from-yellow-500 via-amber-500 to-orange-500 opacity-60 blur-3xl mix-blend-multiply dark:opacity-70 dark:mix-blend-screen"
          style={{ animation: "hero-float-slow 16s ease-in-out infinite" }}
        />
        <div
          className="absolute -right-32 top-10 h-72 w-72 rounded-full bg-gradient-to-br from-yellow-400 via-amber-400 to-yellow-500 opacity-50 blur-3xl mix-blend-multiply dark:opacity-70 dark:mix-blend-screen"
          style={{ animation: "hero-float-medium 14s ease-in-out infinite" }}
        />
        <div
          className="absolute left-1/2 bottom-[-8rem] h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-t from-yellow-500 via-amber-500 to-yellow-600 opacity-40 blur-[110px] mix-blend-multiply dark:opacity-60 dark:mix-blend-screen"
          style={{ animation: "hero-float-fast 18s ease-in-out infinite" }}
        />

        {/* Floating particles (Yellow theme) */}
        <div className="absolute inset-0">
          {PARTICLES.map((p, index) => (
            <span
              key={index}
              className="absolute h-1 w-1 rounded-full bg-yellow-400/70 shadow-[0_0_16px_rgba(252,211,77,0.85)] blur-[1px] dark:bg-yellow-300/80 dark:shadow-[0_0_18px_rgba(253,230,138,0.9)]"
              style={{
                top: p.top,
                left: p.left,
      ...
      {/* Local keyframes for hero background animations (Unchanged, as they control movement) */}
      <style jsx global>{`
        ...
        @keyframes hero-particle {
          ...
          50% {
            transform: translate3d(0, -26px, 0) scale(1.35);
            opacity: 0.9;
          }
        }
      `}</style>
...
// --- Logo Components Refactored for Theme Compliance ---
// Added a className prop and used fill="currentColor" for the primary parts,
// and a class 'accent' for the yellow parts, which are targeted in the main component.

const WorkOsLogo = (props) => {
  return (
    <svg
      {...props}
    ...
    >
      <g>
        ...
        ></path>
        <path
          fill="var(--accent-color, #FFD700)" // Yellow Accent
          className="accent"
...
const AstroLogo = (props) => {
  return (
    ...
    >
      ...
      />
      <defs>
        {/* Removed LinearGradient to keep the accent a solid color, which is easier to theme */}
      </defs>
    </svg>
  );
};
...
const NetlifyLogo = (props) => {
  // NOTE: Netlify's logo is complex due to multiple colors.
  // I've kept the geometry and made the original blue/green parts
  // yellow via the 'accent' class, and the darker parts 'currentColor'.
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
